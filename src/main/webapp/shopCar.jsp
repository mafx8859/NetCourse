...
<ul class="Top_ul">
  ...
  <li class="Top_ul_right Top_ul_right1" ><a href="shopCar.jsp"><img style="margin-left:12px;margin-top:5px;"src="images/gouwuche.PNG"><font>购物车</font></a></li>
...
<div class="center_top">
  <ul class="myShopcar_1"><font>我的购物车</font></ul>
<div>
<div class="ShopCarcenter">
<ul id="shopCar_top_ul1">
<li><input type="checkbox" onclick="selectAll()" id="selectAll"/>全选</li>
<li>课程</li>
<li class="shopcar_money">金额</li>
<li class="opeation">操作</li>
</ul>
<ul id="shopCar_ul2">
  <form action="AllServlet?flag=shopCarJs" method="post">
   <c:forEach items="${sessionScope.shopCar}" var="course">
   <ul class="shopCar_Course">
      <li><input type="checkbox" name="shopCarJs" value="${course.id }" onclick="priceSum(${course.price},this)" class="shopCar_select"/></li>
      <li><img width="150px" height="70px"src="${course.image}"/></li>
      <li class="shopCar_price"><font style="color:red;">￥</font><font class="shopCar_font_price" style="color:red;">${course.price}</font></li>
      <li class="shopCar_gb"><a href="AllServlet?flag=delShopCar&shopCarId=${course.id}"><img width="30px" height="30px" src="images/gb.jpg"/></a></li>
   </ul>
   <br/>
   </c:forEach>
   <li class="goJs" style="background-color:red;"><input type="submit" value="去结算"></li>
   <input id="input_allPrice" name="allPrice" type="hidden"/>
   </form>
    <li class="allPrice">总计金额：￥<br><font style="color:red;" id="allPrice">0</font></li>
</ul>
</div>
</body>
</html>
